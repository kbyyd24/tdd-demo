describe('test cases for findCountedWordSpec', () => {
  ...
  it('should return null when given an empty countedWords array', () => {
    const word = 'a';
    const countedWords = [];
    const countedWord = findCountedWord(word, countedWords);
    expect(countedWord).toBe(null);
  });
  it('should return wordCount when given a countedWords array include given word', () => {
    const word = 'a';
  ...
  it('should return null when given a countedWords array ont include given word', () => {
    const word = 'a';
